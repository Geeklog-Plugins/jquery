...
$.extend(ColorPickerInstance.prototype, {
	...
	_generateColorPicker: function() {
        ...
        var width = 18;
	    var html = "<table border='0px' cellspacing='1' cellpadding='0' bgcolor='#000000'>";
		...
		html += '<tr><td title="" style="background-color:#333" class="color" colspan="' + width + '" align="center"><label>No Color</label></td></tr>'
