...
(function(jQuery) {
	...
	var imgs_url = theblogurl+'/jquery/images';
	jQuery.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			imgs_url+'/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			imgs_url+'/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			imgs_url+'/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			imgs_url+'/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				imgs_url+'/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
